...
session_start();
 ...
 $api->setApplicationName("CIT480 Home Management"); // Set Application name
 $api->setClientId('484495651786-f4sehbvs7di261vdb9lc5faf1ttef4ul.apps.googleusercontent.com'); // Set Client ID
 $api->setClientSecret('aYejOT8pVfpw11MKVQ4JSRUS'); //Set client Secret
